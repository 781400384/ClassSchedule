...
- (void)completeOnClick:(id)sender{
    ...
    if ([self.delegate respondsToSelector:@selector(completingTheSelection:city:)]) {
        [self.delegate completingTheSelection:p.province city:c.city];
    }
    self.isComplete = YES;
    [self hide:YES];
